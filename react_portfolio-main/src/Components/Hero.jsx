...
import "../styles.css";
const technologies = ["Aptitude", "Verbal Reasoning", "Soft Skills", "Life Skills", "Business Communication", "Finance", "Marketing", "Insurance", "Banking", "Mechanical Tech"];

function Hero() {
  const [techIndex, setTechIndex] = useState(0);
  const [setLetterIndex] = useState(0);
  ...
  const social = [
    ...
    { logo: "logo-twitter", link: "https://twitter.com/i/flow/login?redirect_after_login=%2Fthameemahamed96" },
  ];
  ...
  return (
    ...
    >
      <div className="flex-1 flex items-center justify-center h-full">
        <img src="/src\assets\images\Ahamed.png" alt="" class="md:w-11/12 h-full object-cover"/>
      </div>
